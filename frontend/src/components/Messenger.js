...
const Messenger = () => {
  ...
  useEffect(() => {
    const getMessages = async () => {
      try {
        console.log("http://localhost:5000/api/messages/" + currentChat);
            ...
            <div class="w-full ">
              ...
              <div class="overflow-auto flex flex-col ">
                {projects.map((project) => (
                  <div
                    class="ml-2 shadow-md mt-2 mb-2 cursor-pointer hover:bg-gray-200 hover:scale-105"
                    onClick={() => {
                      handleJoinUser();
                  ...
                  >
                    <div class="flex">
                      <img src={group} class="h-10 rounded-full" alt=""></img>
                    ...
                    <div class="bg-blue-300 mt-4 h-px w-full shadow-lg "> </div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div class="flex fixed bg-blue-100 h-full w-full">
          ...
          <div class="flex flex-col justify-between w-full overflow-scroll">
            ...
            <div class="flex sticky bottom-0 py-5">
              <textarea
                class="w-64 h-24 px-3 ml-2 py-2"
                placeholder="write something..."
                onChange={(e) => setNewMessage(e.target.value)}
                value={newMessage}
              ></textarea>
              <button
                class="w-16 h-10 border-2 bg-blue-500 hover:bg-blue-600 text-white font-bold px-2 rounded focus:outline-none focus:shadow-outline ml-2"
